...
window.AppLaporanPengeluaran = {
    ...
    init: function() {
        ...
        window.sb.from('kasKeluar').order('createdAt', { ascending: false }).limit(50).get().then(snap => {
            self.data = [];
    ...
    simpan: function() {
        ...
        window.sb.from('kasKeluar').insert(obj).then(() => {
    ...
    approve: function(id) {
        ...
        window.sb.from('kasKeluar').update({
            status: 'approved',
    ...
    reject: function(id) {
        ...
        window.sb.from('kasKeluar').update({ status: 'rejected' }).then(() => {
