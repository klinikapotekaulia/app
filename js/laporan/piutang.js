...
window.AppLaporanPiutang = {
    ...
    init: function() {
        ...
        var pPiutang = window.sb.from('piutangKaryawan').order('createdAt', { ascending: false }).limit(50).get();
    ...
    simpan: function() {
        ...
        window.sb.from('piutangKaryawan').insert(obj).then(() => {
    ...
    lunasi: function(id) {
        ...
        window.sb.from('piutangKaryawan').update({
            status: 'lunas',
