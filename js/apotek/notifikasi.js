...
window.AppApotekNotifikasi = {
    ...
    renderStokMenipis: function() {
        ...
        // Filter obat yang stok <= stok_minimum
        var list = this.allObat.filter(function(o) {
            return (o.stok || 0) <= (o.stok_minimum || 0);
        }).sort(function(a, b) {
    ...
    exportLaporan: function() {
        ...
        // Stok menipis
        var stokMenipis = this.allObat.filter(function(o) { return (o.stok || 0) <= (o.stok_minimum || 0); });
        ...
        if (stokMenipis.length === 0) {
            ...
            stokMenipis.forEach(function(o) {
                lines.push('  [' + (o.kode_obat || '-') + '] ' + o.nama_obat + ' — Stok: ' + (o.stok || 0) + ' ' + (o.satuan || '') + ' (min: ' + (o.stok_minimum || 0) + ')');
            });
        }
        lines.push('');
